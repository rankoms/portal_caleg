				...
				<div class="card mb-4">
					...
					<div class="row row-bordered g-0">
						...
						<div class="col-md p-4">
							...
							<div class="form-check form-check-info">
								<input name="customRadioInfo" class="form-check-input" type="radio" value="" id="customRadioInfo"
									checked />
								<label class="form-check-label" for="customRadioInfo"> Info </label>
							</div>
							<div class="form-check form-check-dark">
								<input name="customRadioDark" class="form-check-input" type="radio" value="" id="customRadioDark"
									checked />
