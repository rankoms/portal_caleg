						...
						<li class="d-flex mb-4 pb-2">
							...
							<div class="d-flex flex-column w-100">
								...
								<div class="progress" style="height:6px;">
									<div class="progress-bar bg-primary" style="width: 40%" role="progressbar" aria-valuenow="40"
			...
			<div class="card h-100">
				<div class="card-header d-flex align-items-center justify-content-between">
					...
					<div class="dropdown btn-pinned">
						<button class="btn p-0" type="button" id="financoalReport" data-bs-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false">
							<i class="bx bx-dots-vertical-rounded"></i>
						</button>
				...
				<div class="card-body">
					<div class="d-flex flex-wrap gap-4 mb-5 mt-4">
						...
						<div class="d-flex flex-column me-2">
							...
							<ul class="list-unstyled me-2 d-flex align-items-center avatar-group mb-0">
								...
								<li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Ellen Wagner"
									class="avatar avatar-xs pull-up">
					...
					<span>I distinguish three main text objectives. First, your objective could be merely to inform people. A second be
